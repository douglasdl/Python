...
BIRD_IMGS = [pygame.transform.scale2x(pygame.image.load(os.path.join("img", "bird1.png"))), pygame.transform.scale2x(pygame.image.load(os.path.join("img", "bird3.png"))), pygame.transform.scale2x(pygame.image.load(os.path.join("img", "bird3.png")))]
...
def draw_window(win, birds, pipes, base, score, gen, alive):
	...
	text = STAT_FONT.render("Alive: " + str(alive) + " / 10", 1, (255, 255, 255))
